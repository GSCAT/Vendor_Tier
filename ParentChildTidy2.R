...
Parent_Vendor_Table <- read_csv(paste(choose_file_directory(), 'Vendor_Workbook_Kevin_w_LGCY_ID_v5.csv' , sep = '/'))
...
#  for use in the "Preferred Vendor (new)" table in the SOT Monthly model
